...
var _IStorageProvider = _interopRequireDefault(require("../../../shared/container/providers/StorageProvider/modules/IStorageProvider"));
...
let UpdateUserAvatarService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  constructor(usersRepository, storagetprovider) {
    this.usersRepository = usersRepository;
    this.storagetprovider = storagetprovider;
  }
  ...
  async execute({
    ...
    if (!user) throw new _AppError.default('Only authenticated users can change avatar', 401); // Verifica se usuário tem avatar já cadastrado
