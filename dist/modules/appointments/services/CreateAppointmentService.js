...
let CreateAppointmentService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if ((0, _dateFns.isBefore)(appointmentDate, Date.now())) throw new _AppError.default("You can't schedule in a past date");
    if (provider_id === user_id) throw new _AppError.default(`you can't create an appoint with yourself`);
    if ((0, _dateFns.getHours)(appointmentDate) < 8 || (0, _dateFns.getHours)(appointmentDate) > 17) throw new _AppError.default(`you can only create an appoint between 8am and 5pm`);
